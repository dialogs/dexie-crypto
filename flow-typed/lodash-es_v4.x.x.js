...
declare module 'lodash-es' {
  ...
  // Array
  declare export function chunk<T>(
    array?: ?Array<T>,
    size?: ?number,
  ): Array<Array<T>>;
  ...
  declare export function dropRight<T>(
    array?: ?Array<T>,
    n?: ?number,
  ): Array<T>;
  declare export function dropRightWhile<T>(
    array?: ?Array<T>,
    predicate?: ?Predicate<T>,
  ): Array<T>;
  declare export function dropWhile<T>(
    array?: ?Array<T>,
    predicate?: ?Predicate<T>,
  ): Array<T>;
  ...
  declare export function flatten<T, X>(
    array?: ?Array<Array<T> | X>,
  ): Array<T | X>;
  declare export function flattenDeep<T>(array?: ?(any[])): Array<T>;
  declare export function flattenDepth(
    array?: ?(any[]),
    depth?: ?number,
  ): any[];
  declare export function fromPairs<A, B>(
    pairs?: ?Array<[A, B]>,
  ): { [key: A]: B, ... };
  declare export function head<T>(array: ?$ReadOnlyArray<T>): T;
  declare export function indexOf<T>(
    array: Array<T>,
    value: T,
    fromIndex?: number,
  ): number;
  ...
  declare export function intersection<T>(
  ...
  declare export function lastIndexOf<T>(
    array: Array<T>,
    value?: ?T,
    fromIndex?: ?number,
  ): number;
  ...
  declare export function pull<T>(
    array: Array<T>,
    ...values?: Array<?T>
  ): Array<T>;
  declare export function pull<T: void | null>(
    array: T,
    ...values?: Array<?any>
  ): T;
  declare export function pullAll<T>(
    array: Array<T>,
    values?: ?Array<T>,
  ): Array<T>;
  declare export function pullAll<T: void | null>(
    array: T,
    values?: ?Array<any>,
  ): T;
  ...
  declare export function pullAt<T>(
    array?: ?Array<T>,
    ...indexed?: Array<?number>
  ): Array<T>;
  declare export function pullAt<T>(
    array?: ?Array<T>,
    indexed?: ?Array<number>,
  ...
  declare export function sortedLastIndexOf<T>(
    array: Array<T>,
    value: T,
  ): number;
  declare export function sortedLastIndexOf<T>(
  ...
  declare export function takeRight<T>(
    array?: ?Array<T>,
    n?: ?number,
  ): Array<T>;
  declare export function takeRightWhile<T>(
    array?: ?Array<T>,
    predicate?: ?Predicate<T>,
  ): Array<T>;
  ...
  declare export function uniqBy<T>(
    array?: ?Array<T>,
    iteratee?: ?ValueOnlyIteratee<T>,
  ): Array<T>;
  declare export function uniqWith<T>(
    array?: ?Array<T>,
    comparator?: ?Comparator<T>,
  ): Array<T>;
  declare export function unzip<T>(array?: ?Array<T>): Array<T>;
  declare export function unzipWith<T>(
    array: ?Array<T>,
    iteratee?: ?Iteratee<T>,
  ): Array<T>;
  declare export function without<T>(
    array?: ?$ReadOnlyArray<T>,
    ...values?: Array<?T>
  ): Array<T>;
  ...
  declare export function zip<A, B, C>(
    a1: A[],
    a2: B[],
    a3: C[],
  ): Array<[?A, ?B, ?C]>;
  declare export function zip<A, B, C, D>(
    a1: A[],
    a2: B[],
    a3: C[],
    a4: D[],
  ...
  declare export function zipObject<K, V>(
    props: Array<K>,
    values?: ?Array<V>,
  ): { [key: K]: V, ... };
  declare export function zipObject<K, V>(
  ...
  declare export function zipObjectDeep(
    props: void | null,
    values?: ?any,
  ): { ... };

  declare export function zipWith<A>(a1?: ?Array<A>): Array<[A]>;
  declare export function zipWith<T, A>(
    a1: Array<A>,
    iteratee: (A) => T,
  ): Array<T>;

  declare export function zipWith<A, B>(
    a1: Array<A>,
    a2: Array<B>,
  ): Array<[A, B]>;
  ...
  declare export function countBy<T: Object>(
    object: T,
    iteratee?: ?ValueOnlyIteratee<T>,
  ): Object;
  ...
  declare export function each<T: void | null>(
    array: T,
    iteratee?: ?Iteratee<any>,
  ): T;
  declare export function each<T: Object>(
    object: T,
    iteratee?: ?OIteratee<T>,
  ): T;
  declare export function eachRight<T>(
    array: $ReadOnlyArray<T>,
    iteratee?: ?Iteratee<T>,
  ): Array<T>;
  declare export function eachRight<T: void | null>(
    array: T,
    iteratee?: ?Iteratee<any>,
  ): T;
  declare export function eachRight<T: Object>(
    object: T,
    iteratee?: OIteratee<T>,
  ): T;
  ...
  declare export function every<T: Object>(
    object: T,
    iteratee?: OIteratee<T>,
  ): boolean;
  ...
  declare export function forEach<T: void | null>(
    array: T,
    iteratee?: ?Iteratee<any>,
  ): T;
  declare export function forEach<T: Object>(
    object: T,
    iteratee?: ?OIteratee<T>,
  ): T;
  ...
  declare export function forEachRight<T: void | null>(
    array: T,
    iteratee?: ?Iteratee<any>,
  ): T;
  declare export function forEachRight<T: Object>(
    object: T,
    iteratee?: ?OIteratee<T>,
  ): T;
  ...
  declare export function includes<T>(
    array: $ReadOnlyArray<T>,
    value: T,
    fromIndex?: ?number,
  ): boolean;
  ...
  declare export function includes<T: Object>(
    object: T,
    value: any,
    fromIndex?: number,
  ): boolean;
  declare export function includes(
    str: string,
    value: string,
    fromIndex?: number,
  ): boolean;
  ...
  declare export function sampleSize<V, T: Object>(
    object: T,
    n?: number,
  ): Array<V>;
  ...
  declare export function size(
    collection: $ReadOnlyArray<any> | Object | string,
  ): number;
  ...
  declare export function bindKey(
    obj?: ?Object,
    key?: ?string,
    ...partials?: Array<?any>
  ): Function;
  ...
  declare export function defer(
    func: Function,
    ...args?: Array<any>
  ): TimeoutID;
  declare export function delay(
    func: Function,
    wait: number,
    ...args?: Array<any>
  ): TimeoutID;
  ...
  declare export function overArgs(
    func?: ?Function,
  ...
  declare export function partialRight(
    func: Function,
    ...partials: Array<any>
  ): Function;
  declare export function partialRight(
  ...
  declare export function isArrayLike(
    value: Array<any> | string | { length: number, ... },
  ): true;
  declare export function isArrayLike(value: any): false;
  declare export function isArrayLikeObject(
    value: { length: number, ... } | Array<any>,
  ): true;
  ...
  declare export function isNative(
    value: number | string | void | null | Object,
  ): false;
  ...
  declare export function maxBy<T>(
    array: ?$ReadOnlyArray<T>,
    iteratee?: Iteratee<T>,
  ): T;
  declare export function mean(array: Array<*>): number;
  declare export function meanBy<T>(
    array: Array<T>,
    iteratee?: Iteratee<T>,
  ): number;
  declare export function min<T>(array: ?Array<T>): T;
  declare export function minBy<T>(
    array: ?$ReadOnlyArray<T>,
    iteratee?: Iteratee<T>,
  ): T;
  ...
  declare export function sumBy<T>(
    array: Array<T>,
    iteratee?: Iteratee<T>,
  ): number;
  ...
  declare export function random(
    lower?: number,
    upper?: number,
    floating?: boolean,
  ): number;
  ...
  declare export function assignIn<A, B, C, D>(
    a: A,
    b: B,
    c: C,
    d: D,
  ): A & B & C & D;
  declare export function assignIn<A, B, C, D, E>(
    a: A,
    b: B,
    c: C,
    d: D,
  ...
  declare export function create(
    prototype: any,
    properties: void | null,
  ): { ... };
  declare export function defaults(
    object?: ?Object,
    ...sources?: Array<?Object>
  ): Object;
  declare export function defaultsDeep(
    object?: ?Object,
    ...sources?: Array<?Object>
  ): Object;
  // alias for _.toPairs
  ...
  declare export function extend<A, B, C, D>(
    a: A,
    b: B,
    c: C,
    d: D,
  ): A & B & C & D;
  declare export function extend<A, B, C, D, E>(
    a: A,
    b: B,
    c: C,
    d: D,
  ...
  declare export function extendWith<
    T: Object,
    A: Object,
    B: Object,
    C: Object,
  ...
  declare export function forInRight(
    object: Object,
    iteratee?: ?OIteratee<*>,
  ): Object;
  declare export function forInRight(
  ...
  declare export function forOwn(
    object: Object,
    iteratee?: ?OIteratee<*>,
  ): Object;
  declare export function forOwn(
  ...
  declare export function forOwnRight(
    object: Object,
    iteratee?: ?OIteratee<*>,
  ): Object;
  declare export function forOwnRight(
  ...
  declare export function invertBy(
    object: Object,
    iteratee?: ?Function,
  ): Object;
  declare export function invertBy(
  ...
  declare export function mapKeys(
    object: Object,
    iteratee?: ?OIteratee<*>,
  ): Object;
  declare export function mapKeys(
  ...
  declare export function mapValues(
    object: Object,
    iteratee?: ?OIteratee<*>,
  ): Object;
  declare export function mapValues(
  ...
  declare export function toPairs(
    object?: ?Object | Array<*>,
  ): Array<[string, any]>;
  ...
  declare export function thru<T1, T2>(
    value: T1,
    interceptor: (value: T1) => T2,
  ): T2;
  ...
  declare export function endsWith(
    string: string,
    target?: string,
    position?: ?number,
  ): boolean;
  ...
  declare export function pad(
    string?: ?string,
    length?: ?number,
    chars?: ?string,
  ): string;
  declare export function padEnd(
    string?: ?string,
    length?: ?number,
    chars?: ?string,
  ): string;
  declare export function padStart(
    string?: ?string,
    length?: ?number,
    chars?: ?string,
  ): string;
  ...
  declare export function startsWith(
    string: string,
    target?: string,
    position?: number,
  ): boolean;
  ...
  declare export function bindAll(
    object: Object,
    methodNames?: ?Array<string>,
  ): Object;
  declare export function bindAll<T: void | null>(
    object: T,
    methodNames?: ?Array<string>,
  ): T;
  declare export function bindAll(
  ...
  declare export function defaultTo<T1: number, T2>(
    value: T1,
    defaultValue: T2,
  ): T1 | T2;
  declare export function defaultTo<T1: void | null, T2>(
    value: T1,
    defaultValue: T2,
  ): T2;
  declare export var flow: $ComposeReverse &
    ((funcs: Array<Function>) => Function);
  declare export var flowRight: $Compose &
    ((funcs: Array<Function>) => Function);
  ...
  declare export function matchesProperty(
    path?: ?Array<string> | string,
    srcValue: any,
  ): Function;
  declare export function method(
    path?: ?Array<string> | string,
    ...args?: Array<any>
  ): Function;
  declare export function methodOf(
    object?: ?Object,
    ...args?: Array<any>
  ): Function;
  ...
  declare export function rangeRight(
    start?: ?number,
    end?: ?number,
    step?: ?number,
  ): Array<number>;
  ...
  declare export function times(
    n?: ?number,
    ...rest?: Array<void | null>
  ): Array<number>;
  declare export function times<T>(
    n: number,
    iteratee: (i: number) => T,
  ): Array<T>;
...
declare module 'lodash-es/intersectionWith' {
  declare export default $PropertyType<
    $Exports<'lodash-es'>,
    'intersectionWith',
  >;
}
